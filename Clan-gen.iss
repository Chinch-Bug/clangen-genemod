; Warren-gen Installer Script

#define ApplicationBaseName "Warren-gen"
#define ApplicationFullName "Warren-gen (fan edit) by Sablesteel"

; Update this line to the date of the latest Warren-gen (fan edit) by Sablesteel release 
; (or choose your own version-numbering scheme)
#define ApplicationVersion "2022.08.10"

#define ApplicationURL "https://sablesteel.itch.io/warren-gen-fan-edit"

; Comment out the following line and uncomment the second one in order to place help files, EULA, etc.
; in the same program group as the main Warren-gen' shortcuts
...
;-------------------------------------------------------------------------------
[Icons]
;; Create Warren-gen (fan edit) icons
Name: {group}\Warren-gen (fan edit); Filename: {app}\main.exe; Comment: "Warren-gen (fan edit) by Sablesteel"
Name: {commondesktop}\Warren-gen (fan edit); Filename: {app}\main.exe; Comment: "Warren-gen (fan edit) by Sablesteel";
