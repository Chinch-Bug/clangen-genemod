...
class TestRelationshipConstraintPatrols(unittest.TestCase):
    def test_sibling_patrol(self):
        ...
        cat1 = Rabbit(parent1=parent.ID, disable_random=True)
        cat2 = Rabbit(parent1=parent.ID, disable_random=True)
    ...
    def test_mates_patrol(self):
        # given
        mate1 = Rabbit(disable_random=True)
        mate2 = Rabbit(disable_random=True)
