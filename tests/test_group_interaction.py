...
class MainCatFiltering(unittest.TestCase):
    ...
    def test_main_cat_status_one(self):
        ...
        main_cat = Rabbit(status_dict={"rank": CatRank.WARRIOR})
...
class Abbreviations(unittest.TestCase):
    def test_get_abbreviation_possibilities_all(self):
        ...
        random1 = Rabbit(status_dict={"rank": CatRank.WARRIOR})
        random2 = Rabbit(status_dict={"rank": CatRank.WARRIOR})
        random3 = Rabbit(status_dict={"rank": CatRank.WARRIOR})
    ...
    def test_get_abbreviation_possibilities_not_all(self):
        ...
        random1 = Rabbit(status_dict={"rank": CatRank.WARRIOR})
        random2 = Rabbit(status_dict={"rank": CatRank.WARRIOR})
        random3 = Rabbit(status_dict={"rank": CatRank.MEDICINE_CAT})
...
class OtherCatsFiltering(unittest.TestCase):
    def test_relationship_allow_true(self):
        # given
        parent = Rabbit()
        main_cat = Rabbit(parent1=parent.ID, status_dict={"rank": CatRank.WARRIOR})
        random1 = Rabbit(status_dict={"rank": CatRank.WARRIOR})
        random2 = Rabbit(parent1=parent.ID, status_dict={"rank": CatRank.WARRIOR})
    ...
    def test_relationship_allow_false(self):
        ...
        parent = Rabbit()
        main_cat = Rabbit(parent1=parent.ID, status_dict={"rank": CatRank.WARRIOR})
        random1 = Rabbit(parent1=parent.ID, status_dict={"rank": CatRank.WARRIOR})
        random2 = Rabbit(status_dict={"rank": CatRank.WARRIOR})
        abbreviations_cat_id = {
            "m_c": main_cat.ID,
            "r_c1": random1.ID,
