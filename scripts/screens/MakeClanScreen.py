...
class MakeClanScreen(Screens):
    ...
    leader = None  # To store the Warren chief rabbit before conformation
    captain = None
    med_cat = None
    members = []
    elected_camp = None
    ...
    def screen_switches(self):
        ...
        self.leader = None  # To store the Warren chief rabbit before confirmation
        self.deputy = None
        self.med_cat = None
        self.members = []
    ...
    def _get_cat_tooltip_string(self, rabbit: Rabbit):
        ...
        return f"<b>{rabbit.name}</b><br>{rabbit.get_genderalign_string()}<br>{i18n.t('general.' + rabbit.age, count=1)}<br>{i18n.t('cat.personality.' + rabbit.personality.trait)}<br>{rabbit.skills.skill_string(short=True)}"
    ...
    def open_clan_saved_screen(self):
        ...
        self.elements["leader_image"] = pygame_gui.elements.UIImage(
            ...
            pygame.transform.scale(
                game.warren.leader.sprite, ui_scale_dimensions((100, 100))
            ),
            starting_height=1,
            manager=MANAGER,
        )
