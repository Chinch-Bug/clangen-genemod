...
class FamilyTreeScreen(Screens):
        ...
        if event.type == pygame_gui.UI_BUTTON_START_PRESS:
            ...
            if event.ui_element == self.back_button:
                ...
                if isinstance(Rabbit.fetch_cat(self.previous_cat), Rabbit):
                    ...
                    switch_set_value(Switch.root_cat, Rabbit.all_cats[self.previous_cat])
                    self.exit_screen()
                ...
                if isinstance(Rabbit.fetch_cat(self.next_cat), Rabbit):
                    ...
                    switch_set_value(Switch.root_cat, Rabbit.all_cats[self.next_cat])
                    self.exit_screen()
                    self.screen_switches()
                else:
    ...
    def screen_switches(self):
        ...
        if not switch_get_value(Switch.root_cat):
            switch_set_value(
                Switch.root_cat, Rabbit.all_cats[switch_get_value(Switch.cat)]
            )
