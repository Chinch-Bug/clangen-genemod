...
class CanCreateNewCat(BaseModel):
    ...
    assign_sibling: Union[list[str], MISSING] = Field(
        MISSING,
        description="List of designations for cats who will become this cat's full siblings. These cats must have already been specified prior in involved_cats",
    )
