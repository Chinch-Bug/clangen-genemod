...
def _collect_involved_cats(cat_dict: dict, future_info: dict, clan = game.clan) -> dict:
    """
    ...
    possible_cats = [
        kitty for kitty in Cat.all_cats.values() if kitty.status.group_ID == clan.group_ID
    ]
