...
class PatrolOutcome:
    ...
    def _handle_death(self, patrol: "Patrol") -> str:
        ...
        cats_to_kill = gather_cat_objects(
            Cat, list(dead_cats), patrol, stat_cat=self.stat_cat, clan=patrol.clan
        )
    ...
    def _handle_herbs(self, patrol: "Patrol") -> str:
        ...
        if "random_herbs" in self.herbs:
            ...
            for cat in patrol.patrol_cats:
                ...
                skills = cat.skills.get_all()
                amount_modifier += skills.get(SkillPath.SENSE, 0)
                quantity_modifier += skills.get(SkillPath.CLEVER, 0)
