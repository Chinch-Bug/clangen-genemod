...
from scripts.clan_package.get_clan_cats import find_alive_cats_with_rank, get_alive_clan_queens, get_living_clan_cat_count
...
def event_for_tags(
    tags: list, cat, clan=CatGroup.PLAYER_CLAN_ID, other_cat=None, mentor_tags_fulfilled: dict = None
) -> bool:
    """
