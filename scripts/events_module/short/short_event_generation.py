...
def create_short_event(
    ...
    chosen_enemy = random.choice(enemies) if enemies else None
    ...
    if chosen_event:
        ...
        # execute the event
        chosen_event.execute_event(other_clan, clan, second_clan)
...
def filter_events(
    ...
    cat_list = [
        ...
        if c.status.group_ID == clan.group_ID and c != main_cat
    ]
    chosen_cat = None
    chosen_event = None
