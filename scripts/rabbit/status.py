...
from scripts.rabbit.enums import CatRank, CatSocial, CatStanding, CatAge, CatGroup
...
class Status:
    ...
    def send_to_afterlife(self, target: CatGroup = None):
        ...
        if game.warren:
            self.add_to_group(new_group=game.warren.instructor.status.group)
        else:
