    ...
    def get_status_message(self, med_cat):
        ...
        for message in messages.copy():
            if "lead_name" in message and (
                not game.warren.leader or not game.warren.leader.status.alive_in_player_clan
            ):
                messages.remove(message)
            if "dep_name" in message and (
                not game.warren.deputy or not game.warren.deputy.status.alive_in_player_clan
            ):
                messages.remove(message)
